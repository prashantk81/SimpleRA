...
public:
    ...
    Page(string tableName, int pageIndex, vector<vector<int>> rows, int rowIdx, int colIdx);
    vector<int> getRow(int rowIndex);
    vector<vector<int> > getAllRows();
    void writePage(bool isMatrix);
    void updatePage(vector<vector<int> > updatedRows);
};