...
{
    logger.log("sematicParsePRINTMATRIX");
    if (!tableCatalogue.isTable(parsedQuery.printMatrixName))
    {
        cout << "SEMANTIC ERROR: Relation doesn't exist" << endl;
        return false;
    }
...
void executePRINTMATRIX()
{
    ...
    Table *table = tableCatalogue.getTable(parsedQuery.printMatrixName);
